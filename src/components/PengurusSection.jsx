...
const groups = [
  ...
  },
  {
    ...
    members: [
      ...
      { name: 'Sintong Sihombing', role: 'Anggota', initials: 'SS' },
  ...
  },
  {
    ...
    members: [
      ...
      { name: 'Melisa Sidabutar', role: 'Guru sekolah minggu', initials: 'MS' },
      { name: 'Wahyu Gultom', role: 'Guru sekolah minggu', initials: 'WG' },
    ],
  },
]
